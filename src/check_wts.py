...
attn_wts = torch.load('attn_wts_112.pt', map_location=lambda storage, loc: storage.cuda(4))
inputs = torch.load('inputs_112.pt', map_location=lambda storage, loc: storage.cuda(4))
