...
for index in "${!cuda_list[@]}"; do
    ...
    file_name="practice/split_data_${split_data}_layer_begin_${layer_begin}_num_extract_${num_extract}_anchor_${anchor}_template_${template}_wrong_spaced.txt"
    echo "$file_name"
