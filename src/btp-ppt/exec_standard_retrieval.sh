#!/bin/bash
cuda_list=("7")
split_data_list=("False")
num_extract_list=("20")
anchor_list=("2")
template_list=("2")
data_file_list=("dataset/combined_facts_pad.txt")
layer_begin_list=("0")
count_file_list=("dataset/token_counts_pad.json")
for index in "${!cuda_list[@]}"; do
    ...
    file_name="surfing_2pad_access_check.txt"
    echo "$file_name"
