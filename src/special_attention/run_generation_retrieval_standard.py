...
from unlimiformer_retrieval_standard import Unlimiformer
...
def main():
    ...
    parser.add_argument("--num_anchors", type=int, default=2, help="random seed for initialization")
    parser.add_argument("--num_templates", type=int, default=2, help="random seed for initialization")
    parser.add_argument("--num_extract", type=int, default=20, help="random seed for initialization")
    parser.add_argument("--split_data", type=bool, default=True, help="random seed for initialization")
    parser.add_argument("--token_count_file", type=str, default="", help="random seed for initialization")
    parser.add_argument("--data_file", type=str, default="", help="random seed for initialization")
    ...
    args.device = torch.device(f"cuda:{unlimiformer_args.datastore_device}" if torch.cuda.is_available() and not args.no_cuda else "cpu")
