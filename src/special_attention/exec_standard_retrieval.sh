...
for index in "${!cuda_list[@]}"; do
    ...
    file_name="split_data_${split_data}_layer_begin_15_num_extract_${num_extract}_anchor_${anchor}_template_${template}_wrong_remove_last_7_and_1_close_up_layer1.txt"
    echo "$file_name"
